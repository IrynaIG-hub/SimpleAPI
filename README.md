...
Base url is https://fakerestapi.azurewebsites.net and keeps in env.properties file. Also there is an allure.properties file that can have allure properies.